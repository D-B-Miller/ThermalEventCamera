...
class EventRecorder{
	...
	hsize_t tdimsext[2] = {834,1}; // current size of the dataset as we extend it
        hsize_t tdims[2] = {834,1}; // starter dimensions
        hsize_t tchunk_dims[2] = {834,1}; // dunk dims
        hsize_t toffset[2] = {0,0}; // offset for hyperslab
	hsize_t tmaxdims[2] = {834,H5S_UNLIMITED};
